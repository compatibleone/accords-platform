...
#ifndef _exampleprocci_c_
#define _exampleprocci_c_
...
/*	--------------------------------------------	*/
/*	l i b e r a t e _ e x a m p l e p r o c c i 	*/
/*	--------------------------------------------	*/
public struct exampleprocci * liberate_exampleprocci(struct exampleprocci * sptr)
{
	if ( sptr )
	{
		if ( sptr->id )
	...
	return((struct exampleprocci *) 0);

}

/*	--------------------------------------	*/
/*	r e s e t _ e x a m p l e p r o c c i 	*/
/*	--------------------------------------	*/
public struct exampleprocci * reset_exampleprocci(struct exampleprocci * sptr)
{
	if ( sptr )
	{
		sptr->id = (char*) 0;
...
/*	--------------------------------------------	*/
/*	a l l o c a t e _ e x a m p l e p r o c c i 	*/
/*	--------------------------------------------	*/
public struct exampleprocci * allocate_exampleprocci()
{
	struct exampleprocci * sptr;
	if (!( sptr = allocate( sizeof( struct exampleprocci ) ) ))
		return( sptr );
	else	return( reset_exampleprocci(sptr) );
}

/*	--------------------------------------	*/
/*	x m l i n _ e x a m p l e p r o c c i 	*/
/*	--------------------------------------	*/
public int xmlin_exampleprocci(struct exampleprocci * sptr,struct xml_element * eptr)
{
...
/*	----------------------------------------------	*/
/*	r e s t _ o c c i _ e x a m p l e p r o c c i 	*/
/*	----------------------------------------------	*/
public int rest_occi_exampleprocci(FILE * fh,struct exampleprocci * sptr,char * prefix, char * nptr)
{
	struct xml_element * wptr;
	if (!( sptr )) return(0);
