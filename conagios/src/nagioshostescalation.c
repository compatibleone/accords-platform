...
#ifndef _nagioshostescalation_c_
#define _nagioshostescalation_c_
...
/*	--------------------------------------------------------------	*/
/*	l i b e r a t e _ n a g i o s _ h o s t _ e s c a l a t i o n 	*/
/*	--------------------------------------------------------------	*/
public struct nagios_host_escalation * liberate_nagios_host_escalation(struct nagios_host_escalation * sptr)
{
	if ( sptr )
	{
		if ( sptr->id )
	...
	return((struct nagios_host_escalation *) 0);

}

/*	--------------------------------------------------------	*/
/*	r e s e t _ n a g i o s _ h o s t _ e s c a l a t i o n 	*/
/*	--------------------------------------------------------	*/
public struct nagios_host_escalation * reset_nagios_host_escalation(struct nagios_host_escalation * sptr)
{
	if ( sptr )
	{
		sptr->id = (char*) 0;
...
/*	--------------------------------------------------------------	*/
/*	a l l o c a t e _ n a g i o s _ h o s t _ e s c a l a t i o n 	*/
/*	--------------------------------------------------------------	*/
public struct nagios_host_escalation * allocate_nagios_host_escalation()
{
	struct nagios_host_escalation * sptr;
	if (!( sptr = allocate( sizeof( struct nagios_host_escalation ) ) ))
		return( sptr );
	else	return( reset_nagios_host_escalation(sptr) );
}

/*	--------------------------------------------------------	*/
/*	x m l i n _ n a g i o s _ h o s t _ e s c a l a t i o n 	*/
/*	--------------------------------------------------------	*/
public int xmlin_nagios_host_escalation(struct nagios_host_escalation * sptr,struct xml_element * eptr)
{
...
/*	----------------------------------------------------------------	*/
/*	r e s t _ o c c i _ n a g i o s _ h o s t _ e s c a l a t i o n 	*/
/*	----------------------------------------------------------------	*/
public int rest_occi_nagios_host_escalation(FILE * fh,struct nagios_host_escalation * sptr,char * prefix, char * nptr)
{
	struct xml_element * wptr;
	if (!( sptr )) return(0);
...
#endif	/* _nagioshostescalation_cnagioshostescalation_c_ */
