...
/*	---------------------------------------------		*/
private	int	load_orga_subscription( char * filename )
{
...
/*	---------------------------------------------		*/
public	struct	orga_subscription * check_orga_subscription( char * filename )
{
	if (!( OrgaSubscription.subscription ))
	{
		if (!( load_orga_subscription( filename ) ))
