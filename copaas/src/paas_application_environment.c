...
#ifndef _paas_application_environment_c_
#define _paas_application_environment_c_
...
/*	--------------------------------------------------------------------------	*/
/*	l i b e r a t e _ p a a s _ a p p l i c a t i o n _ e n v i r o n m e n t 	*/
/*	--------------------------------------------------------------------------	*/
public struct paas_application_environment * liberate_paas_application_environment(struct paas_application_environment * sptr)
{
	if ( sptr )
	{
		if ( sptr->id )
	...
	return((struct paas_application_environment *) 0);

}

/*	--------------------------------------------------------------------	*/
/*	r e s e t _ p a a s _ a p p l i c a t i o n _ e n v i r o n m e n t 	*/
/*	--------------------------------------------------------------------	*/
public struct paas_application_environment * reset_paas_application_environment(struct paas_application_environment * sptr)
{
	if ( sptr )
	{
		sptr->id = (char*) 0;
...
/*	--------------------------------------------------------------------------	*/
/*	a l l o c a t e _ p a a s _ a p p l i c a t i o n _ e n v i r o n m e n t 	*/
/*	--------------------------------------------------------------------------	*/
public struct paas_application_environment * allocate_paas_application_environment()
{
	struct paas_application_environment * sptr;
	if (!( sptr = allocate( sizeof( struct paas_application_environment ) ) ))
		return( sptr );
	else	return( reset_paas_application_environment(sptr) );
}

/*	--------------------------------------------------------------------	*/
/*	x m l i n _ p a a s _ a p p l i c a t i o n _ e n v i r o n m e n t 	*/
/*	--------------------------------------------------------------------	*/
public int xmlin_paas_application_environment(struct paas_application_environment * sptr,struct xml_element * eptr)
{
...
/*	----------------------------------------------------------------------------	*/
/*	r e s t _ o c c i _ p a a s _ a p p l i c a t i o n _ e n v i r o n m e n t 	*/
/*	----------------------------------------------------------------------------	*/
public int rest_occi_paas_application_environment(FILE * fh,struct paas_application_environment * sptr,char * prefix, char * nptr)
{
	struct xml_element * wptr;
	if (!( sptr )) return(0);
...
#endif	/* _paas_application_environment_cpaas_application_environment_c_ */
