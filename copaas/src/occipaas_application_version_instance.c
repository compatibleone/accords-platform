...
/*	------------------------------------	*/
private struct rest_response * delete_action_paas_application_version_instance(struct occi_category * optr, 
...
void * vptr )
{
	...
	return( occi_paas_application_version_instance_delete(optr,cptr,rptr));
}
