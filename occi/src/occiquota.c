...
#ifndef _occiquota_c_
#define _occiquota_c_

#include "quota.h"

/*	--------------------------------	*/
/*	o c c i _ c o r d s _ q u o t a 	*/
/*	--------------------------------	*/

/*	--------------------------------------------------------------------	*/
/*	o c c i   c a t e g o r y   m a n a g e m e n t   s t r u c t u r e 	*/
/*	--------------------------------------------------------------------	*/
struct cords_quota * allocate_cords_quota();
struct cords_quota * liberate_cords_quota(struct cords_quota * optr);
private pthread_mutex_t list_cords_quota_control=PTHREAD_MUTEX_INITIALIZER;
private struct occi_kind_node * cords_quota_first = (struct occi_kind_node *) 0;
private struct occi_kind_node * cords_quota_last  = (struct occi_kind_node *) 0;
public struct  occi_kind_node * occi_first_cords_quota_node() { return( cords_quota_first ); }
public struct  occi_kind_node * occi_last_cords_quota_node() { return( cords_quota_last ); }

/*	----------------------------------------------	*/
/*	o c c i   c a t e g o r y   d r o p   n o d e 	*/
/*	----------------------------------------------	*/
private struct occi_kind_node * ll_drop_cords_quota_node(struct occi_kind_node * nptr) {
	if ( nptr ) {
	if (!( nptr->previous ))
		cords_quota_first = nptr->next;
	else	nptr->previous->next = nptr->next;
	if (!( nptr->next ))
		cords_quota_last = nptr->previous;
	else	nptr->next->previous = nptr->previous;
		liberate_occi_kind_node( nptr );
		}
	return((struct occi_kind_node *)0);
}
private struct occi_kind_node * drop_cords_quota_node(struct occi_kind_node * nptr) {
	pthread_mutex_lock( &list_cords_quota_control );
	nptr = ll_drop_cords_quota_node( nptr );
	pthread_mutex_unlock( &list_cords_quota_control );
	return(nptr);
}
...
/*	--------------------------------------------------	*/
private struct occi_kind_node * ll_locate_cords_quota_node(char * id) {
	struct occi_kind_node * nptr;
	struct cords_quota * pptr;
	for ( nptr = cords_quota_first;
...
private struct occi_kind_node * locate_cords_quota_node(char * id) {
	struct occi_kind_node * nptr;
	pthread_mutex_lock( &list_cords_quota_control );
	nptr = ll_locate_cords_quota_node(id);
	pthread_mutex_unlock( &list_cords_quota_control );
	return( nptr );
}
...
/*	--------------------------------------------	*/
private struct occi_kind_node * ll_add_cords_quota_node(int mode) {
	struct occi_kind_node * nptr;
	struct cords_quota * pptr;
	if (!( nptr = allocate_occi_kind_node() ))
		return( nptr );
	else	{
		if (!( nptr->contents = allocate_cords_quota()))
		...
		if (!( pptr = nptr->contents ))
			...
			if (!( nptr->previous = cords_quota_last ))
				cords_quota_first = nptr;
			else	nptr->previous->next = nptr;
			cords_quota_last = nptr;
			return( nptr );
			}
		}
}
private struct occi_kind_node * add_cords_quota_node(int mode) {
	struct occi_kind_node * nptr;
	pthread_mutex_lock( &list_cords_quota_control );
	nptr = ll_add_cords_quota_node( mode );
	pthread_mutex_unlock( &list_cords_quota_control );
	return(nptr);
}
...
/*	------------------------------------------------------------------------------------------	*/
private char*autosave_cords_quota_name="cords_quota.xml";
private void autoload_cords_quota_nodes() {
	char * fn=autosave_cords_quota_name;	struct occi_kind_node * nptr;
	struct cords_quota * pptr;
	...
	if (!( document = document_parse_file(fn)))
		return;
	if ((eptr = document_element(document,"cords_quotas")) != (struct xml_element *) 0) {
		for (vptr=eptr->first; vptr != (struct xml_element *) 0; vptr=vptr->next) {
			if (!( vptr->name )) continue;
			else if ( strcmp( vptr->name, "cords_quota" ) ) continue;
			else if (!( nptr = add_cords_quota_node(0))) break;
...
/*	------------------------------------------------------------------------------------------	*/
public  void set_autosave_cords_quota_name(char * fn) {
	autosave_cords_quota_name = fn;	return;
}
public  void autosave_cords_quota_nodes() {
	char * fn=autosave_cords_quota_name;	struct occi_kind_node * nptr;
	struct cords_quota * pptr;
	FILE * h;
	pthread_mutex_lock( &list_cords_quota_control );
	if (( h = fopen(fn,"w")) != (FILE *) 0) {
	fprintf(h,"<cords_quotas>\n");
	for ( nptr = cords_quota_first;
		nptr != (struct occi_kind_node *) 0;
		nptr = nptr->next ) {
		if (!( pptr = nptr->contents )) continue;
		fprintf(h,"<cords_quota\n");
...
/*	------------------------------------------------------------------------------------------	*/
private void set_cords_quota_field(
...
/*	--------------------------------------------------	*/
private struct cords_quota * filter_cords_quota_info(
	struct occi_category * optr,
	struct rest_request  * rptr,
	struct rest_response * aptr) {
	struct cords_quota * pptr;
		if (!( pptr = allocate_cords_quota()))
		return( pptr );
	else if (!( occi_process_atributs(optr, rptr, aptr, pptr, set_cords_quota_field) ))
		return( liberate_cords_quota(pptr));
	else	return( pptr );
}
...
/*	--------------------------------------------------	*/
private int pass_cords_quota_filter(
	struct cords_quota * pptr,struct cords_quota * fptr) {
	if (( fptr->id )
	&&  (strlen( fptr->id ) != 0)) {
		if (!( pptr->id ))
			return(0);
...
/*	----------------------------------------------------------------------------------------	*/
private struct rest_response * cords_quota_occi_response(
	...
	struct cords_quota * pptr)
{
	...
	if (!( hptr = rest_response_header( aptr, "X-OCCI-Attribute",cptr->buffer) ))
		return( rest_html_response( aptr, 500, "Server Failure" ) );
	sprintf(cptr->buffer,"%s.%s.offered=%c%u%c",optr->domain,optr->id,0x0022,pptr->offered,0x0022);
	if (!( hptr = rest_response_header( aptr, "X-OCCI-Attribute",cptr->buffer) ))
		return( rest_html_response( aptr, 500, "Server Failure" ) );
	sprintf(cptr->buffer,"%s.%s.reserved=%c%u%c",optr->domain,optr->id,0x0022,pptr->reserved,0x0022);
	if (!( hptr = rest_response_header( aptr, "X-OCCI-Attribute",cptr->buffer) ))
		return( rest_html_response( aptr, 500, "Server Failure" ) );
	sprintf(cptr->buffer,"%s.%s.consumed=%c%u%c",optr->domain,optr->id,0x0022,pptr->consumed,0x0022);
	if (!( hptr = rest_response_header( aptr, "X-OCCI-Attribute",cptr->buffer) ))
		return( rest_html_response( aptr, 500, "Server Failure" ) );
	sprintf(cptr->buffer,"%s.%s.granularity=%c%u%c",optr->domain,optr->id,0x0022,pptr->granularity,0x0022);
	if (!( hptr = rest_response_header( aptr, "X-OCCI-Attribute",cptr->buffer) ))
		return( rest_html_response( aptr, 500, "Server Failure" ) );
...
/*	----------------------------------------------------------------------------------------	*/
private struct rest_response * cords_quota_get_item(
	struct occi_category * optr, struct rest_client * cptr,
	struct rest_request * rptr, struct rest_response * aptr, char * id)
{
	...
	struct cords_quota * pptr;
	iptr = optr->callback;
	if (!( nptr = locate_cords_quota_node(id)))
		return( rest_html_response( aptr, 404, "Not Found") );
	else if (!( pptr = nptr->contents ))
		return( rest_html_response( aptr, 404, "Not Found") );
	if (( iptr ) && (iptr->retrieve)) (*iptr->retrieve)(optr,nptr,rptr);
	autosave_cords_quota_nodes();
	return( cords_quota_occi_response(optr,cptr,rptr,aptr,pptr));
}

/*	------------------------------------------------------------------------------------------	*/
/*	o c c i   c a t e g o r y   r e s t   i n t e r f a c e   m e t h o d   p o s t   l i n k 	*/
/*	------------------------------------------------------------------------------------------	*/
private struct rest_response * cords_quota_post_link(
	struct occi_category * optr, struct rest_client * cptr,
	struct rest_request * rptr, struct rest_response * aptr,char * id)
{
	struct rest_header * hptr;
...
/*	--------------------------------------------------------------------------------------------	*/
private struct rest_response * cords_quota_post_mixin(
	struct occi_category * optr, struct rest_client * cptr,
	struct rest_request * rptr, struct rest_response * aptr,char * id)
{
	struct rest_header * hptr;
...
/*	----------------------------------------------------------------------------------------------	*/
private struct rest_response * cords_quota_post_action(
	struct occi_category * optr, struct rest_client * cptr,
	struct rest_request * rptr, struct rest_response * aptr,char * id)
{
	struct rest_header * hptr;
...
/*	------------------------------------------------------------------------------------------	*/
private struct rest_response * cords_quota_post_item(
	struct occi_category * optr, struct rest_client * cptr,
	struct rest_request * rptr, struct rest_response * aptr)
{
	struct rest_header * hptr;
	...
	if (!( nptr = add_cords_quota_node(1)))
		return( rest_html_response( aptr, 500, "Server Failure") );
	else if (!( pptr = nptr->contents ))
		return( rest_html_response( aptr, 500, "Server Failure") );
	if (!( occi_process_atributs( optr, rptr,aptr, pptr, set_cords_quota_field ) ))
		return( rest_html_response( aptr, 500, "Server Failure") );
...
/*	----------------------------------------------------------------------------------------	*/
private struct rest_response * cords_quota_put_item(
	struct occi_category * optr, struct rest_client * cptr,
	struct rest_request * rptr, struct rest_response * aptr,char * id)
{
	struct rest_header * hptr;
...
/*	------------------------------------------------------------------------------------------	*/
private struct rest_response * cords_quota_head_item(
	struct occi_category * optr, struct rest_client * cptr,
	struct rest_request * rptr, struct rest_response * aptr,char * id)
{
	struct rest_header * hptr;
...
/*	----------------------------------------------------------------------------------------------	*/
private struct rest_response * cords_quota_delete_item(
	struct occi_category * optr, struct rest_client * cptr,
	struct rest_request * rptr, struct rest_response * aptr, char * id)
{
	struct rest_header * hptr;
...
/*	----------------------------------------------------------------------------------------	*/
private struct rest_response * cords_quota_get_list(
	struct occi_category * optr, struct rest_client * cptr,
	struct rest_request * rptr, struct rest_response * aptr)
{
	struct rest_header * hptr;
	...
	struct cords_quota * pptr;
	struct cords_quota * fptr;
	char * reqhost;
	if (!( reqhost = rest_request_host( rptr ) ))
		return( rest_html_response( aptr, 400, "Bad Request" ) );
	else if (!( fptr = filter_cords_quota_info( optr, rptr, aptr ) ))
		return( rest_html_response( aptr, 400, "Bad Request" ) );
	for ( sptr = cords_quota_first;
		sptr != (struct occi_kind_node *) 0;
		sptr = sptr->next ) {
		if (!( pptr = sptr->contents ))
			continue;
		if (!( pass_cords_quota_filter( pptr, fptr ) ))
			continue;
		sprintf(cptr->buffer,"%s%s%s",reqhost,optr->location,pptr->id);
		if (!( hptr = rest_response_header( aptr, "X-OCCI-Location",cptr->buffer) ))
			return( rest_html_response( aptr, 500, "Server Failure" ) );
...
/*	--------------------------------------------------------------------------------------------	*/
private struct rest_response * cords_quota_delete_all(
	struct occi_category * optr, struct rest_client * cptr,
	struct rest_request * rptr, struct rest_response * aptr)
{
	struct rest_header * hptr;
	...
	struct cords_quota * fptr;
	iptr = optr->callback;
	if (!( fptr = filter_cords_quota_info( optr, rptr, aptr ) ))
		return( rest_html_response( aptr, 400, "Bad Request" ) );
	nptr=cords_quota_first;
	while (nptr != (struct occi_kind_node *) 0) {
		if ((!( pptr = nptr->contents ))
		||  (!( pass_cords_quota_filter( pptr, fptr ) ))) {
			nptr = nptr->next;
			continue;
			}
		else	{
...
/*	------------------------------------------------------------------------------	*/
private struct rest_response * occi_cords_quota_get(void * vptr, struct rest_client * cptr, struct rest_request * rptr)
{
	struct rest_response * aptr;
	struct rest_header   * hptr;
	struct occi_category * optr;
	...
	if(!(aptr = rest_allocate_response( cptr )))
		...
		return( cords_quota_get_list( optr, cptr, rptr, aptr ) );
	else if (!(strncmp( rptr->object, optr->location, strlen(optr->location) ) ))
		return( cords_quota_get_item( optr, cptr, rptr, aptr,rptr->object+strlen(optr->location) ) );
	else	return( rest_html_response( aptr, 400, "Bad Request") );
}
...
/*	--------------------------------------------------------------------------------	*/
private struct rest_response * occi_cords_quota_head(void * vptr, struct rest_client * cptr, struct rest_request * rptr)
{
	struct rest_response * aptr;
	struct rest_header   * hptr;
	struct occi_category * optr;
	...
	if(!(aptr = rest_allocate_response( cptr )))
		...
		return( cords_quota_head_item( optr, cptr, rptr, aptr,rptr->object+strlen(optr->location) ) );
	else	return( rest_html_response( aptr, 400, "Bad Request") );
}
...
/*	--------------------------------------------------------------------------------	*/
private struct rest_response * occi_cords_quota_post(void * vptr, struct rest_client * cptr, struct rest_request * rptr)
{
	struct rest_response * aptr;
	struct rest_header   * hptr;
	struct occi_category * optr;
	...
	if(!(aptr = rest_allocate_response( cptr )))
		...
		return( cords_quota_post_item( optr, cptr, rptr, aptr ) );
	else if ( strncmp( rptr->object, optr->location,strlen(optr->location)) != 0)
		return( rest_html_response( aptr, 400, "Bad Request") );
	else if (!( rptr->parameters ))
		return( rest_html_response( aptr, 400, "Bad Request") );
	else if (!( strncmp( rptr->parameters, "action=", strlen("action=")) ))
		return( cords_quota_post_action( optr, cptr, rptr, aptr,rptr->object+strlen(optr->location) ) );
	else if (!( strncmp( rptr->parameters, "mixin=", strlen("mixin=")) ))
		return( cords_quota_post_mixin( optr, cptr, rptr, aptr,rptr->object+strlen(optr->location) ) );
	else if (!( strncmp( rptr->parameters, "link=", strlen("link=")) ))
		return( cords_quota_post_link( optr, cptr, rptr, aptr,rptr->object+strlen(optr->location) ) );
	else	return( rest_html_response( aptr, 400, "Bad Request") );
}
...
/*	------------------------------------------------------------------------------	*/
private struct rest_response * occi_cords_quota_put(void * vptr, struct rest_client * cptr, struct rest_request * rptr)
{
	struct rest_response * aptr;
	struct rest_header   * hptr;
	struct occi_category * optr;
	...
	if(!(aptr = rest_allocate_response( cptr )))
		...
		return( cords_quota_put_item( optr, cptr, rptr, aptr,rptr->object+strlen(optr->location) ) );
	else	return( rest_html_response( aptr, 400, "Bad Request") );
}
...
/*	------------------------------------------------------------------------------------	*/
private struct rest_response * occi_cords_quota_delete(void * vptr, struct rest_client * cptr, struct rest_request * rptr)
{
	struct rest_response * aptr;
	struct rest_header   * hptr;
	struct occi_category * optr;
	...
	if(!(aptr = rest_allocate_response( cptr )))
		...
		return( cords_quota_delete_all( optr, cptr, rptr, aptr ) );
	else if (!(strncmp( rptr->object, optr->location, strlen(optr->location) ) ))
		return( cords_quota_delete_item( optr, cptr, rptr, aptr,rptr->object+strlen(optr->location) ) );
	else	return( rest_html_response( aptr, 400, "Bad Request") );
}
...
/*	--------------------------------------------------------------------------------	*/
private void	redirect_occi_cords_quota_mt( struct rest_interface * iptr )
{
	iptr->get = occi_cords_quota_get;
	iptr->post = occi_cords_quota_post;
	iptr->put = occi_cords_quota_put;
	iptr->delete = occi_cords_quota_delete;
	iptr->head = occi_cords_quota_head;
	return;
}
...
/*	------------------------------------	*/
private struct rest_response * delete_action_cords_quota(struct occi_category * optr, 
...
void * vptr )
{
	...
	return( occi_cords_quota_delete(optr,cptr,rptr));
}

/*	------------------------------------------	*/
/*	o c c i   c a t e g o r y   b u i l d e r 	*/
/*	------------------------------------------	*/
/* occi category rest instance builder for : occi_cords_quota */
public struct occi_category * occi_cords_quota_builder(char * a,char * b) {
	char * c="http://scheme.compatibleone.fr/scheme/compatible#";
	char * d="kind";
	char * e="http://scheme.ogf.org/occi/resource#";
	char * f="CompatibleOne OCCI resource cords_quota";
	struct occi_category * optr;
	if (!( optr = occi_create_category(a,b,c,d,e,f) )) { return(optr); }
	else {
		redirect_occi_cords_quota_mt(optr->interface);
...
/*	------------------------------------------------	*/
/*	c o r d s _ q u o t a _ o c c i _ h e a d e r s 	*/
/*	------------------------------------------------	*/
public struct rest_header *  cords_quota_occi_headers(struct cords_quota * sptr)
{
	...
	if (!( hptr->name = allocate_string("Category")))
		return(first);
	sprintf(buffer,"cords_quota; scheme='http://scheme.compatibleone.fr/scheme/compatible#'; class='kind';\r\n");
	...
	if (!( hptr->name = allocate_string("X-OCCI-Attribute")))
		return(first);
	sprintf(buffer,"occi.cords_quota.name='%s'\r\n",(sptr->name?sptr->name:""));
	if (!( hptr->value = allocate_string(buffer)))
		return(first);
	if (!( hptr = allocate_rest_header()))
		return(first);
	...
	if (!( hptr->name = allocate_string("X-OCCI-Attribute")))
		return(first);
	sprintf(buffer,"occi.cords_quota.property='%s'\r\n",(sptr->property?sptr->property:""));
	if (!( hptr->value = allocate_string(buffer)))
		return(first);
	if (!( hptr = allocate_rest_header()))
		return(first);
	...
	if (!( hptr->name = allocate_string("X-OCCI-Attribute")))
		return(first);
	sprintf(buffer,"occi.cords_quota.description='%s'\r\n",(sptr->description?sptr->description:""));
	if (!( hptr->value = allocate_string(buffer)))
		return(first);
	if (!( hptr = allocate_rest_header()))
		return(first);
	...
	if (!( hptr->name = allocate_string("X-OCCI-Attribute")))
		return(first);
	sprintf(buffer,"occi.cords_quota.price='%s'\r\n",(sptr->price?sptr->price:""));
	if (!( hptr->value = allocate_string(buffer)))
		return(first);
	if (!( hptr = allocate_rest_header()))
		return(first);
	...
	if (!( hptr->name = allocate_string("X-OCCI-Attribute")))
		return(first);
	sprintf(buffer,"occi.cords_quota.units='%s'\r\n",(sptr->units?sptr->units:""));
	if (!( hptr->value = allocate_string(buffer)))
		return(first);
	if (!( hptr = allocate_rest_header()))
		return(first);
	...
	if (!( hptr->name = allocate_string("X-OCCI-Attribute")))
		return(first);
	sprintf(buffer,"occi.cords_quota.reserved='%u'\r\n",sptr->reserved);
	if (!( hptr->value = allocate_string(buffer)))
		return(first);
	if (!( hptr = allocate_rest_header()))
		return(first);
