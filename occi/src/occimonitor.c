...
/*	--------------------------------------------------------------------	*/
private struct rest_interface occi_cords_monitor_mt = {
	(void*) 0,
	(void*) 0,
	(void*) 0,
	occi_cords_monitor_get,
	occi_cords_monitor_post,
	occi_cords_monitor_put,
	occi_cords_monitor_delete,
	occi_cords_monitor_head,
	(void*) 0
	};
...
public struct occi_category * occi_cords_monitor_builder(char * a,char * b) {
	...
	if (!( optr = occi_create_category(a,b,c,d,e,f) )) { return(optr); }
		...
		optr->interface = &occi_cords_monitor_mt;
