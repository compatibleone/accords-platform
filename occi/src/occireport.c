	...
	struct rest_request * rptr, struct rest_response * aptr)
{
	...
	if (!( reqhost = rest_request_host( rptr ) ))
		return( rest_html_response( aptr, 400, "Bad Request" ) );
	else if (!( fptr = filter_cords_report_info( optr, rptr, aptr ) ))
		return( rest_html_response( aptr, 400, "Bad Request" ) );
...
/*	--------------------------------------------------------------------	*/
private struct rest_interface occi_cords_report_mt = {
	(void*) 0,
	(void*) 0,
	(void*) 0,
	occi_cords_report_get,
	occi_cords_report_post,
	occi_cords_report_put,
	occi_cords_report_delete,
	occi_cords_report_head,
	(void*) 0
	};
...
public struct occi_category * occi_cords_report_builder(char * a,char * b) {
	...
	if (!( optr = occi_create_category(a,b,c,d,e,f) )) { return(optr); }
		...
		optr->interface = &occi_cords_report_mt;
