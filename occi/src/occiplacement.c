...
/*	--------------------------------------------------------------------	*/
private struct rest_interface occi_cords_placement_mt = {
	(void*) 0,
	(void*) 0,
	(void*) 0,
	occi_cords_placement_get,
	occi_cords_placement_post,
	occi_cords_placement_put,
	occi_cords_placement_delete,
	occi_cords_placement_head,
	(void*) 0
	};
...
public struct occi_category * occi_cords_placement_builder(char * a,char * b) {
	...
	if (!( optr = occi_create_category(a,b,c,d,e,f) )) { return(optr); }
		...
		optr->interface = &occi_cords_placement_mt;
