...
private void autoload_cords_optimise_nodes() {
	...
	if (!( document = document_parse_file(fn) ))
		return;
	else if ((eptr = document_element(document,"cords_optimises")) != (struct xml_element *) 0) {
...
/*	--------------------------------------------------------------------	*/
private struct rest_interface occi_cords_optimise_mt = {
	(void*) 0,
	(void*) 0,
	(void*) 0,
	occi_cords_optimise_get,
	occi_cords_optimise_post,
	occi_cords_optimise_put,
	occi_cords_optimise_delete,
	occi_cords_optimise_head,
	(void*) 0
	};
...
public struct occi_category * occi_cords_optimise_builder(char * a,char * b) {
	...
	if (!( optr = occi_create_category(a,b,c,d,e,f) )) { return(optr); }
		...
		optr->interface = &occi_cords_optimise_mt;
