...
/*	--------------------------------------------------------------------	*/
private struct rest_interface occi_windowsazure_mt = {
	(void*) 0,
	(void*) 0,
	(void*) 0,
	occi_windowsazure_get,
	occi_windowsazure_post,
	occi_windowsazure_put,
	occi_windowsazure_delete,
	occi_windowsazure_head,
	(void*) 0
	};
...
public struct occi_category * occi_windowsazure_builder(char * a,char * b) {
	...
	if (!( optr = occi_create_category(a,b,c,d,e,f) )) { return(optr); }
		...
		optr->interface = &occi_windowsazure_mt;
