...
/*	--------------------------------------------------------------------	*/
private struct rest_interface occi_publication_mt = {
	(void*) 0,
	(void*) 0,
	(void*) 0,
	occi_publication_get,
	occi_publication_post,
	occi_publication_put,
	occi_publication_delete,
	occi_publication_head,
	(void*) 0
	};
...
public struct occi_category * occi_publication_builder(char * a,char * b) {
	...
	if (!( optr = occi_create_category(a,b,c,d,e,f) )) { return(optr); }
		...
		optr->interface = &occi_publication_mt;
