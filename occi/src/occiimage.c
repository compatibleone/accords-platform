...
/*	--------------------------------------------------------------------	*/
private struct rest_interface occi_cords_image_mt = {
	(void*) 0,
	(void*) 0,
	(void*) 0,
	occi_cords_image_get,
	occi_cords_image_post,
	occi_cords_image_put,
	occi_cords_image_delete,
	occi_cords_image_head,
	(void*) 0
	};
...
public struct occi_category * occi_cords_image_builder(char * a,char * b) {
	...
	if (!( optr = occi_create_category(a,b,c,d,e,f) )) { return(optr); }
		...
		optr->interface = &occi_cords_image_mt;
