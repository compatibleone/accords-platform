...
/*	--------------------------------------------------------------------	*/
private struct rest_interface occi_cords_service_mt = {
	(void*) 0,
	(void*) 0,
	(void*) 0,
	occi_cords_service_get,
	occi_cords_service_post,
	occi_cords_service_put,
	occi_cords_service_delete,
	occi_cords_service_head,
	(void*) 0
	};
...
public struct occi_category * occi_cords_service_builder(char * a,char * b) {
	...
	if (!( optr = occi_create_category(a,b,c,d,e,f) )) { return(optr); }
		...
		optr->interface = &occi_cords_service_mt;
...
public struct rest_header *  cords_service_occi_headers(struct cords_service * sptr)
{
	...
	if (!( hptr->name = allocate_string("X-OCCI-Attribute")))
		return(first);
	sprintf(buffer,"occi.cords_service.tarification='%s'\r\n",(sptr->tarification?sptr->tarification:""));
	if (!( hptr->value = allocate_string(buffer)))
		return(first);
	if (!( hptr = allocate_rest_header()))
		return(first);
