...
/*	------------------------------------	*/
/*	l i b e r a t e _ o p e n s t a c k 	*/
/*	------------------------------------	*/
...
/*	------------------------------	*/
/*	r e s e t _ o p e n s t a c k 	*/
/*	------------------------------	*/
public struct openstack * reset_openstack(struct openstack * sptr)
{
	if ( sptr )
	{
		sptr->id = (char*) 0;
...
/*	------------------------------------	*/
/*	a l l o c a t e _ o p e n s t a c k 	*/
/*	------------------------------------	*/
public struct openstack * allocate_openstack()
{
	struct openstack * sptr;
	if (!( sptr = allocate( sizeof( struct openstack ) ) ))
		return( sptr );
	else	return( reset_openstack(sptr) );
}

/*	------------------------------	*/
/*	x m l i n _ o p e n s t a c k 	*/
/*	------------------------------	*/
public int xmlin_openstack(struct openstack * sptr,struct xml_element * eptr)
{
...
/*	--------------------------------------	*/
/*	r e s t _ o c c i _ o p e n s t a c k 	*/
/*	--------------------------------------	*/
public int rest_occi_openstack(FILE * fh,struct openstack * sptr,char * prefix, char * nptr)
{
	struct xml_element * wptr;
	if (!( sptr )) return(0);
