...
/*	--------------------------------------	*/
/*	l i b e r a t e _ d e l t a c l o u d 	*/
/*	--------------------------------------	*/
public struct deltacloud * liberate_deltacloud(struct deltacloud * sptr)
{
	if ( sptr )
	{
		if ( sptr->id )
	...
	return((struct deltacloud *) 0);

}

/*	--------------------------------	*/
/*	r e s e t _ d e l t a c l o u d 	*/
/*	--------------------------------	*/
public struct deltacloud * reset_deltacloud(struct deltacloud * sptr)
{
	if ( sptr )
	{
		sptr->id = (char*) 0;
...
/*	--------------------------------------	*/
/*	a l l o c a t e _ d e l t a c l o u d 	*/
/*	--------------------------------------	*/
public struct deltacloud * allocate_deltacloud()
{
	struct deltacloud * sptr;
	if (!( sptr = allocate( sizeof( struct deltacloud ) ) ))
		return( sptr );
	else	return( reset_deltacloud(sptr) );
}

/*	--------------------------------	*/
/*	x m l i n _ d e l t a c l o u d 	*/
/*	--------------------------------	*/
public int xmlin_deltacloud(struct deltacloud * sptr,struct xml_element * eptr)
{
...
/*	----------------------------------------	*/
/*	r e s t _ o c c i _ d e l t a c l o u d 	*/
/*	----------------------------------------	*/
public int rest_occi_deltacloud(FILE * fh,struct deltacloud * sptr,char * prefix, char * nptr)
{
	struct xml_element * wptr;
	if (!( sptr )) return(0);
