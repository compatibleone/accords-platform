...
/*	------------------------------------------	*/
/*	l i b e r a t e _ w i n d o w s a z u r e 	*/
/*	------------------------------------------	*/
public struct windowsazure * liberate_windowsazure(struct windowsazure * sptr)
{
	if ( sptr )
	{
		if ( sptr->id )
...
/*	------------------------------------	*/
/*	r e s e t _ w i n d o w s a z u r e 	*/
/*	------------------------------------	*/
public struct windowsazure * reset_windowsazure(struct windowsazure * sptr)
{
	if ( sptr )
	{
		sptr->id = (char*) 0;
...
/*	------------------------------------------	*/
/*	a l l o c a t e _ w i n d o w s a z u r e 	*/
/*	------------------------------------------	*/
public struct windowsazure * allocate_windowsazure()
{
	struct windowsazure * sptr;
	if (!( sptr = allocate( sizeof( struct windowsazure ) ) ))
		return( sptr );
	else	return( reset_windowsazure(sptr) );
}

/*	------------------------------------	*/
/*	x m l i n _ w i n d o w s a z u r e 	*/
/*	------------------------------------	*/
public int xmlin_windowsazure(struct windowsazure * sptr,struct xml_element * eptr)
{
...
/*	--------------------------------------------	*/
/*	r e s t _ o c c i _ w i n d o w s a z u r e 	*/
/*	--------------------------------------------	*/
public int rest_occi_windowsazure(FILE * fh,struct windowsazure * sptr,char * prefix, char * nptr)
{
	struct xml_element * wptr;
	if (!( sptr )) return(0);
