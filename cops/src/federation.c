...
#ifndef _federation_c_
#define _federation_c_
...
/*	--------------------------------------------------	*/
/*	l i b e r a t e _ c o r d s _ f e d e r a t i o n 	*/
/*	--------------------------------------------------	*/
public struct cords_federation * liberate_cords_federation(struct cords_federation * sptr)
{
	if ( sptr )
	{
		if ( sptr->id )
	...
	return((struct cords_federation *) 0);

}

/*	--------------------------------------------	*/
/*	r e s e t _ c o r d s _ f e d e r a t i o n 	*/
/*	--------------------------------------------	*/
public struct cords_federation * reset_cords_federation(struct cords_federation * sptr)
{
	if ( sptr )
	{
		sptr->id = (char*) 0;
...
/*	--------------------------------------------------	*/
/*	a l l o c a t e _ c o r d s _ f e d e r a t i o n 	*/
/*	--------------------------------------------------	*/
public struct cords_federation * allocate_cords_federation()
{
	struct cords_federation * sptr;
	if (!( sptr = allocate( sizeof( struct cords_federation ) ) ))
		return( sptr );
	else	return( reset_cords_federation(sptr) );
}

/*	--------------------------------------------	*/
/*	x m l i n _ c o r d s _ f e d e r a t i o n 	*/
/*	--------------------------------------------	*/
public int xmlin_cords_federation(struct cords_federation * sptr,struct xml_element * eptr)
{
...
/*	----------------------------------------------------	*/
/*	r e s t _ o c c i _ c o r d s _ f e d e r a t i o n 	*/
/*	----------------------------------------------------	*/
public int rest_occi_cords_federation(FILE * fh,struct cords_federation * sptr,char * prefix, char * nptr)
{
	struct xml_element * wptr;
	if (!( sptr )) return(0);
...
#endif	/* _federation_cfederation_c_ */
