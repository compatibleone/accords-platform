[[[cog import codegen.cog_common as t; t.init_models(model_dir); t.h_include(cog_category_file) ]]]
[[[end]]]
...
/*	--------------------------------------------------	*/
[[[cog t.pass_category_filter(cog_category_file)]]]
[[[end]]]
	return(1);
}
...
[[[end]]] 
())) { break; }
			[[[cog t.load_attributes(cog_category_file)]]]
			[[[end]]]
     		if (!( add_
[[[cog t.category_name(cog_category_file)]]]
[[[end]]] 
...
[[[end]]] 
\n");
		[[[cog t.save_attributes(cog_category_file)]]]
		[[[end]]]
		fprintf(h," />\n");
		}
	fprintf(h,"</
