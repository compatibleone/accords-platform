...
/// @return 0 if successful.
extern int dump_onapp_data( struct oa_config const * pptr, struct onapp *ponapp, FILE *h);
...
/// @param h File to dump to.
/// @return 0 if successful.
extern int dump_onapp_data_stdout(struct oa_config const * pptr, struct onapp *ponapp);

/// @brief Dump url to FILE.
/// @param purl url to dump.
/// @param h File to dump to.
extern void dump_url(struct url const *purl, FILE *hOutput);

/// @brief Dump occi_attribute to FILE.
/// @param pocci_attribute occi_attribute to dump.
/// @param h File to dump to.
extern void dump_occi_attribute(struct occi_attribute const *pocci_attribute, FILE *hOutput);

extern void test_dump_occi_category(struct occi_category const *pocci_category, FILE *hOutput);

/// @brief Dump rest_response to FILE.
/// @param prest_response rest_response to dump.
/// @param h File to dump to.
extern void dump_rest_response(struct rest_response const *prest_response, FILE *hOutput);

/// @brief Dump occi_response to FILE.
/// @param pocci_response occi_response to dump.
/// @param h File to dump to.
extern void dump_occi_response(struct occi_response const * pocci_response, FILE* hOutput);
...
/// @param h File to dump to.
extern void dump_occi_client(struct occi_client const *pocci_client, FILE *hOutput);
...
/// @param h File to dump to.
extern void dump_onapp_extras(struct cords_onapp_extras const *ponapp_extras, FILE *hOutput);
