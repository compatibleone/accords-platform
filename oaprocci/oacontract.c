...
struct oa_config * resolve_oa_configuration( char * sptr )
{
	...
	struct	occi_kind_node  * occi_first_oa_config_node(char *,char *, char *, int);
	struct	occi_kind_node  * occi_next_oa_config_node(struct occi_kind_node  * );

	for (	nptr = occi_first_oa_config_node("onapp_configuration","name",sptr,0);
...
struct cords_onapp_extras_handle resolve_cords_onapp_extras_handle( char * sptr, char *agent, char *tls )
{
  ...
  return handle;
	...
	struct	occi_kind_node  * occi_first_cords_onapp_extras_node(char *,char *, char *, int);
	struct	occi_kind_node  * occi_next_cords_onapp_extras_node(struct occi_kind_node  *);

	for (nptr = occi_first_cords_onapp_extras_node("onapp_extras","name",sptr,0);
		nptr != (struct occi_kind_node *) 0;
